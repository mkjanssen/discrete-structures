...
\addtocontents{toc}{\protect\hypertarget{g:book:idm197256098032}{}}
...
\thispagestyle{empty}
\hypertarget{g:colophon:idm197256095520}{}\vspace*{\stretch{2}}
...
The existential quantifier is \(\exists\) and is read ``there exists'' or ``there is.'' For example, \index{existential quantifier}\index{quantifier!there exists}\index{there exists (quantifier)}\label{g:notation:idm197255982128}%
\begin{equation*}
\exists x (x \lt 0)
\end{equation*}
asserts that there is a number less than 0.%
\par
The universal quantifier is \(\forall\) and is read ``for all'' or ``every.'' For example, \index{universal quantifier}\index{quantifier!for all}\index{for all (quantifier)}\label{g:notation:idm197255976640}%
\begin{equation*}
\forall x (x \ge 0)
\end{equation*}
...
%
\begin{description}
\item[{\(\emptyset\)}]The \terminology{empty set} is the set which contains no elements. \label{g:notation:idm197255910032}\index{empty set}%
\item[{\(\U\)}]The \terminology{universe set} is the set of all elements. \label{g:notation:idm197255906240}\index{universe set}\index{domain of discourse|see{universe set}}%
\item[{\(\N\)}]The set of natural numbers. That is, \(\N = \{0, 1, 2, 3\ldots\}\). \label{g:notation:idm197255901616}\index{natural numbers, set of}\index{set!of natural numbers}%
\item[{\(\Z\)}]The set of integers. That is, \(\Z = \{\ldots, -2, -1, 0, 1, 2, 3, \ldots\}\). \index{integers, set of}\index{set!of integers}\label{g:notation:idm197255895488}%
\item[{\(\Q\)}]The set of rational numbers. \label{g:notation:idm197255892960}\index{rational numbers, set of}\index{set!of rational numbers}%
\item[{\(\R\)}]The set of real numbers. \label{g:notation:idm197255888848}\index{real numbers, set of}\index{set!of real numbers}%
\item[{\(\pow(A)\)}]The \terminology{power set} of any set \(A\) is the set of all subsets of \(A\). \index{power set}\label{g:notation:idm197255882784}\index{power set}\index{set!of all subsets|see{power set}}%
\end{description}
%
\end{assemblage}
...
\item[{\(\cap\)}]\(A \cap B\) is the \terminology{intersection of \(A\) and \(B\)}: the set containing all elements which are elements of both \(A\) and \(B\). \label{g:notation:idm197255847328}\index{intersection of sets}\index{set!intersection}%
\item[{\(\cup\)}]\(A \cup B\) is the \terminology{union of \(A\) and \(B\)}: is the set containing all elements which are elements of \(A\) or \(B\) or both. \label{g:notation:idm197255840784}\index{union of sets}\index{set!union}%
\item[{\(\times\)}]\(A \times B\) is the \terminology{Cartesian product of \(A\) and \(B\)}: the set of all ordered pairs \((a,b)\) with \(a \in A\) and \(b \in B\). \label{g:notation:idm197255833984}\index{Cartesian product}\index{set!product|see{Cartesian product}}%
\item[{\(\setminus\)}]\(A \setminus B\) is \terminology{set difference between \(A\) and \(B\)}: the set containing all elements of \(A\) which are not elements of \(B\). \label{g:notation:idm197255827184}\index{set!difference}\index{difference of sets}%
\item[{\(\bar{A}\)}]The \terminology{complement of \(A\)} is the set of everything which is not an element of \(A\). \label{g:notation:idm197255822000}\index{set!complement}\index{complement of a set}%
\item[{\(\card{A}\)}]The \terminology{cardinality (or size) of \(A\)} is the number of elements in \(A\). \label{g:notation:idm197255816560}\index{cardinality!of a set}\index{size of a set!see cardinality}\index{set!cardinality}%
\end{description}
%
\end{assemblage}
\end{subsubsectionptx}
...
\includegraphics[width=\linewidth]{./images/arrow-diagrams.png}
\end{image}%
\end{exploration}%
\end{subsubsectionptx}
\end{subsectionptx}
...
\end{investigation}%
\begin{question}{}{g:question:idm197255447296}%
...
\begin{sbspanel}{0.5}%
\includegraphics[width=\linewidth]{./images/chessboard.svg}
\end{sbspanel}%
\end{sidebyside}%
\end{investigation}%
\end{subsubsectionptx}
...
\begin{sbspanel}{0.3}%
\includegraphics[width=\linewidth]{./images/lattice-path-1.svg}
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[width=\linewidth]{./images/lattice-path-2.svg}
\end{sbspanel}%
\begin{sbspanel}{0.3}%
\includegraphics[width=\linewidth]{./images/lattice-path-3.svg}
\end{sbspanel}%
\end{sidebyside}%
...
\begin{sbspanel}{0.7}%
\includegraphics[width=\linewidth]{./images/pascal-nCk.svg}
\end{sbspanel}%
\end{sidebyside}%
\par
...
\begin{sidebyside}{1}{0}{0}{0}%
\begin{sbspanel}{1}%
\includegraphics[width=\linewidth]{./images/pascal-large.svg}
\end{sbspanel}%
\end{sidebyside}%
\end{subsubsectionptx}
\end{subsectionptx}
...
\end{equation*}
To refer to the \emph{entire} sequence at once, we will write \((a_n)_{n\in\N}\) or \((a_n)_{n\ge 0}\), or sometimes if we are being sloppy, just \((a_n)\) (in which case we assume we start the sequence with \(a_0\)). \index{sequence!notation for}\label{g:notation:idm197254967264}%
\par
...
5, 7, 9, \ldots\text{,}
\end{equation*}
which \emph{is} an arithmetic sequence (with constant difference 2). Notice that our original sequence had \terminology{third differences} (that is, differences of differences of differences of the original) constant. We will call such a sequence \(\Delta^3\)-constant. The sequence \(1, 4, 9, 16, \ldots\) has second differences constant, so it will be a \(\Delta^2\)-constant sequence. In general, we will say a sequence is a \terminology{\(\Delta^k\)-constant} \label{g:notation:idm197254718688}\index{Deltak@\(\Delta^k\)-constant} sequence if the \(k\)th differences are constant.%
...
\includegraphics[width=\linewidth]{./images/image-58.svg}
\end{sbspanel}%
\begin{sbspanel}{0.18}[bottom]%
\includegraphics[width=\linewidth]{./images/image-59.svg}
\end{sbspanel}%
\begin{sbspanel}{0.26}[bottom]%
\includegraphics[width=\linewidth]{./images/image-60.svg}
\end{sbspanel}%
\end{sidebyside}%
\par
...
%
\end{assemblage}
\begin{assemblage}{Modus Tollens.}{g:assemblage:idm197269948304}%
\begin{sidebyside}{1}{0}{0}{0}%
\begin{sbspanel}{1}%
\resizebox{\linewidth}{!}{%
{\centering%
...
\begin{sbspanel}{0.35}%
\includegraphics[width=\linewidth]{./images/image-107.svg}
\end{sbspanel}%
\end{sidebyside}%
\par
%
...
\end{assemblage}
\footnotetext[1]{Sometimes this is stated as ``a tree is an acyclic connected graph;'' ``acyclic'' is just a fancy word for ``containing no cycles.''\label{g:fn:idm197253747888}}%
...
\end{sidebyside}%
\end{exploration}%
\index{spanning tree!minimum}\index{minimum spanning tree} Although we will not consider this in detail, these algorithms are usually applied to \emph{weighted} graphs.  Here every edge has some weight or cost assigned to it.  The goal is to find a spanning tree that has the smallest possible combined weight.  Such a tree is called a \terminology{minimum spanning tree}.  Finding the minimum spanning tree uses basically the same algorithms as we described above, but when picking an edge to add, you always pick the smallest (or when removing an edge, you always remove the largest).\footnote{\index{Prim's algorithm}\index{Kruskal's algorithm} If you add the smallest edge adjacent to edges you have already added, you are doing \emph{Prim's algorithm}.  If you add the smallest edge in the entire graph, you are following \emph{Kruskal's algorithm}.\label{g:fn:idm197253588656}}%
\end{subsubsectionptx}
\end{subsectionptx}
%
%
...
\typeout{************************************************}
%
\begin{subsectionptx}{Today's Screencast}{}{Today's Screencast}{}{}{g:subsection:idm197253592096}
\begin{insight}{}{g:insight:idm197253585296}%
\end{insight}
\end{subsectionptx}
%
%
...
%
\typeout{************************************************}
\typeout{Section 14.3 Apr. 16: Independent Portfolio Work Day}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 15.1 Apr. 19: Graph Coloring}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 15.1.1 OutlineColoring Edges}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 15.1.1.1 Chromatic Number}
\typeout{************************************************}
%
\begin{subsubsectionptx}{Chromatic Number}{}{Chromatic Number}{}{}{g:subsubsection:idm197253490288}
A famous problem in graph theory is as follows:%
\begin{quote}%
...
\end{sidebyside}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{p:solution:VAE}{}\quad{}The graph on the left is \(K_6\). The only way to properly color the graph is to give every vertex a different color (since every vertex is adjacent to every other vertex). Thus the chromatic number is 6.%
\par
...
\begin{theorem}{The Four Color Theorem.}{}{x:theorem:thm-four-color}%
\index{Four Color Theorem}%
\index{graph!chromatic number}%
\index{planar graph!chromatic number of}%
...
%
\typeout{************************************************}
\typeout{Subsubsection 15.1.1.2 Coloring in General}
\typeout{************************************************}
%
...
\end{investigation}%
The upshot is that when you wish to partition some objects so that related objects are not in the same set, you can model the problem with graph coloring.%
\par
...
%
\typeout{************************************************}
\typeout{Subsection 15.1.2 Today's Screencast}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 15.1.3 If you missed class today}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 15.2 Apr. 21: Euler Paths and Circuits}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 15.2.1 Outline}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsubsection 15.2.1.1 Euler Paths and Circuits}
\typeout{************************************************}
%
...
\index{path!Hamilton}%
\index{circuit!Euler}%
\index{cycle!Hamilton}%
\index{Euler path}%
\index{Euler circuit}%
\index{Hamilton path}%
\index{Hamilton cycle}%
\index{trail!Euler|see{Euler path}}%
\index{walk!Euler|see{Euler path}}%
\index{tour, Euler|see{Euler circuit}}%
...
%
\end{investigation}%
There is a nice result which determines when a graph has a Euler path or circuit. To prove it, we need a bit more background.%
\begin{definition}{}{g:definition:idm197253353552}%
\index{cut vertex}%
\index{cut edge}%
Let \(G\) be a graph. A vertex \(v\in V(G)$\) is called a \terminology{cut vertex of \(G\)} provided \(G\setminus v\) (that is, \(G\) with \(v\) and any incident edges removed) has more components than \(G\).%
\par
Similarly, an edge \(e\in E(G)\) is called a \terminology{cut edge of \(G\)} provided \(G\setminus e\) has more components than \(G\).%
\end{definition}
In other words, cut vertices an edges disconnect existing connected components of the graph.%
\begin{lemma}{}{}{x:lemma:lem-even-deg-cut-edge}%
Let \(G\) be a connected graph all of whose vertices have even degree. Then no edge of \(G\) is a cut edge.%
\end{lemma}
\begin{proof}{}{g:proof:idm197253343536}
Suppose that \(e=xy\) is a cut edge of such a graph. Then \(G\setminus e\) has two components, and each of these components contain exactly one vertex of odd degree, contradicting the handshake lemma.%
\end{proof}
\begin{lemma}{}{}{x:lemma:lem-two-odd-cut-edge}%
Let \(G\) be a connected graph with exactly two vertices of odd degree. Let \(a\) be a vertex of odd degree and suppose \(d(a)\ne 1\). Then at least one of the edges incident with \(a\) is not a cut edge.%
\end{lemma}
...
%
\typeout{************************************************}
\typeout{Subsubsection 15.2.1.2 Hamilton Paths}
\typeout{************************************************}
%
\begin{subsubsectionptx}{Hamilton Paths}{}{Hamilton Paths}{}{}{g:subsubsection:idm197253376368}
\index{Hamilton path}\index{path!Hamilton}\index{Hamilton cycle}\index{cycle!Hamilton} Suppose you wanted to tour Königsberg in such a way that you visit each land mass (the two islands and both banks) exactly once. This can be done. In graph theory terms, we are asking whether there is a path which visits every vertex exactly once. Such a path is called a \terminology{Hamilton path} (or \terminology{Hamiltonian path}). We could also consider \terminology{Hamilton cycles}, which are Hamilton paths which start and stop at the same vertex.%
...
\end{sidebyside}%
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{p:solution:Pxk}{}\quad{}The graph on the left has a Hamilton path (many different ones, actually), as shown here:%
\begin{sidebyside}{1}{0.4}{0.4}{0}%
\begin{sbspanel}{0.2}%
\resizebox{\linewidth}{!}{%
\begin{tikzpicture}[scale=.5]
...
%
\typeout{************************************************}
\typeout{Subsection 15.2.3 If you missed class today}
\typeout{************************************************}
%
